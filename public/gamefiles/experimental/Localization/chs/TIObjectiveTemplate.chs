...
TIObjectiveTemplate.resolution.ResearchHydraBiology.ResistCouncil=这具外星人尸体为我们提供了一个资讯宝库。目前得知它是碳基生物，吸入氧气，高约 220 公分，膝盖位于腿的上半部，类似地球上的犬科动物，并藉由汗液升华机制进行冷却。至于内部构造，一个显著特征是神经系统和循环系统结合在一起，共有三个心脏/神经群：一个在头部，在最上面的椎骨后面，两个在腹部，位于右季肋区和左髂骨区。这种冗余系统表示，除非有多个心脏/神经群出现灾难性损伤，否则海德拉可以再生自己的大部分机能。虽然失去一个心脏/神经群可能会限制较高层级的认知功能，但有两个心脏/神经群正常运作的外星人，仍然可执行基本到中级的任务。<br/><br/>外星人的再生能力似乎让它们几乎不会衰老，理论上个体似乎能在其自然生命（估计为 160 到 200 年之间）的大部分时间里保持稳定的健康、活动力和认知能力。但这是得付出代价的：它们的生理机能极为复杂，缓慢的妊娠和发育周期相当缓慢且出生率很低。外星人个体在出生时是无性别的，这个物种的每个成员出生时都有潜在的雄性和雌性生殖器官；在它们生命周期的某个时刻，特定条件会促使其中一组器官发育。虽然在地球上并不少见，但我们星球上的顺序雌雄同体现象仅出现在低阶生物身上，例如鱼类、腹足纲动物和植物等。而外星人似乎只在生命周期的尾声才会有性别，且一旦性别分配完成就不会再变回来。<br/><br/>虽然我们在取得这个标本期间记录到的滴答声，已经复杂到足以成为一种语言，但我们不认为听觉交流是海德拉交换讯息的主要方式。相反地，我们发现它们脸上的多尖端突起构造和脖子后隆起的球状构造中，含有精密的感觉器官，这些器官会从空气中收集资料并传递到高度发达的犁鼻器官，类似蛇使用舌头的方式。与蛇不同的是，这些器官还具有快速建构和释放化学资讯流的能力。<br/><br/>我们在这些器官中发现了适应性细胞和各种元素与化合物的储存库，语言学家推测，它们的作用可能是当成某种字母，这代表着一种有趣的双向机制，类似于信息素，只不过是藉由活细胞进行。我们的研究人员将这些细胞称为“信息素细胞”。异形生物学部门的附注：初步研究指出，其中一些信息素细胞可能是专门为影响人类而设计。我们强烈建议立即进行重点研究。
